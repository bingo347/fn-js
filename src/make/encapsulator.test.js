...
assert.strictEqual(7, testRightApply.encapsulate(3)(4), `${PREFIX}: right applyTo`);
assert.strictEqual(7, testLeftApply.encapsulate(3)(4), `${PREFIX}: left applyTo`);

assert.strictEqual(8, testLeftApply.encapsulate(5)(3), `${PREFIX}: reuse applier`);
